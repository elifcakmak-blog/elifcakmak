  ...
  return (
    ...
    <div className="return-policy-container">
      ...
      <div className="return-policy-card">
        ...
        <p>
          We strive to ensure your satisfaction with every purchase from <strong>Muslim Success Path</strong>,  <strong>Effortless Works</strong>, <strong>Effortless Quest</strong>. If you&apos;re not satisfied, we&apos;re here to help.
        </p>
